...
const HS_3 = () => {
  return (
    <div className='flex flex-row bg-[#b71f5c] my-[10%] lg:my-[2.5%]'>
        <div className='w-[50vw] max-h-[700px] h-[700px] p-0 m-0'>
            <img className='w-full h-full object-cover' src={Side} alt='Find Out More Section'/>
        </div>
        <div className='w-[50vw] flex flex-col justify-center items-start pr-[7%] pl-[4%]'>
            ...
            <a className='text-[1.2rem] lg:text-[1.25rem] capitalize font-[400] text-slate-100 border-2 border-slate-100 rounded-md px-3 py-3 hover:text-[var(--logo-red-color)] hover:bg-slate-100 transition ease-in-out duration-[0.5s]' href='/'>To Be An Option</a>
        </div>
    </div>
  )
}

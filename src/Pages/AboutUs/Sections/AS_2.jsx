    ...
    <div className='flex flex-col lg:flex-row px-[7%] py-[10%] lg:pt-[4%] lg:pb-[7%]'>
        <div className='flex flex-col lg:flex-row'>
          ...
          <div className='flex flex-col w-full lg:w-[70%] mt-[10%] lg:mt-0'>
            ...
            <div className='flex flex-col lg:flex-row'>
                <Link className='text-[1.2rem] w-fit lg:text-[1.1rem] capitalize font-[400] text-logo-red border-2 border-logo-red rounded-md px-3 py-3 hover:text-neutral-100 hover:bg-logo-red transition ease-in-out duration-[0.5s] mb-4 lg:mb-0 mr-0 lg:mr-8' to='/for-talent/application/'>Get enlist for jobs</Link>
                <Link className='text-[1.2rem] w-fit lg:text-[1.1rem] capitalize font-[400] text-neutral-50 border-2 border-logo-red rounded-md px-3 py-3 hover:text-logo-red bg-logo-red hover:bg-transparent transition ease-in-out duration-[0.5s]' to='/for-employers/application/'>Highlight as job option</Link>
            </div>
          </div>
        </div> 
    </div>  
